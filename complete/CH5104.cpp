...
int sum[20][20];
int ask(int i, int l, int r) { return sum[i][r] - sum[i][l - 1]; }
...
void print(ref &ans) {
    ...
    rep(i, ans.l, ans.r) { cout << ans.i << ' ' << i << endl; }
